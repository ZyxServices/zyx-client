...
public class AddressController {
    ...
    public ModelAndView delete(@RequestParam(name = "token") String token, @RequestParam(name = "address_id") String addressId) {
        AbstractView jsonView = new MappingJackson2JsonView();
    ...
    public ModelAndView defaultAddress(@RequestParam(name = "token") String token, @RequestParam(name = "account_id") Integer userId, @RequestParam(name = "address_id") String addressId) {
        AbstractView jsonView = new MappingJackson2JsonView();
    ...
    public ModelAndView list(@RequestParam(name = "token") String token, @RequestParam(name = "account_id") Integer userId) {
        AbstractView jsonView = new MappingJackson2JsonView();
